...
function CategoryFilter({ categories, selectedCategories, onChangeCategory }) {
  return (
    <div className="w-full max-w-xs bg-linear-to-br from-sky-600 via-sky-800 to-black border border-gray-700 shadow-xl rounded-2xl p-5 space-y-3 hover:shadow-2xl transition-all duration-300">
