...
>
  ...
  <input
    ...
    className={`w-5 h-5 appearance-none rounded-md cursor-pointer
      border border-sky-500/70 bg-linear-to-br from-black/60 to-sky-900/40
  ...
  {text && (
    <label
      htmlFor={id}
      className={`cursor-pointer text-white font-medium text-sm tracking-wide hover:text-sky-300 transition-colors duration-200 
        ${labelClassName}`}
    >
      {text}
    </label>
